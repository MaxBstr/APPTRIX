# Generated by Django 3.2.12 on 2022-03-27 22:51
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('clients', '0007_alter_client_avatar'),
    ]
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='match',
            constraint=models.UniqueConstraint(fields=('sender', 'recipient'), name='unique_match'),
        ),
    ]
